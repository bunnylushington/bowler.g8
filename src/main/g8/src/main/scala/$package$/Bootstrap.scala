...
// This class acts as the starting point and bootstrap point for
// our application
...
class Bootstrap{
  ...
  val controller = new $controller_name$
	
	
  // allow template reload during development - remove these lines in
